...
class Settings(BaseSettings):
    ...
    translation_batch_max_items: int = Field(default=8, ge=1, le=64)
    translation_batch_max_chars: int = Field(default=8000, ge=500, le=50000)
    translation_batch_max_duration_seconds: float = Field(default=140.0, gt=0, le=900)
